...
class Provider
{
    public const SIPAY = 'sipay';
    public const HALKODE = 'halkode';
    public const IQMONEY = 'iqmoney';
    public const PAROLAPARA = 'parolapara';
    public const PAYBULL = 'paybull';
    public const QNBPAY = 'qnbpay';
    public const VEPARA = 'vepara';
